...
async function run() {
  ...
  check("15) SK product copy present; no dry-run/provider default labels", sk.includes("Tamanor aktuálne chráni") && sk.includes("Skryté pre verejnosť dnes") && sk.includes("Dnešná ochrana") && !cc.includes("dry_run"));
