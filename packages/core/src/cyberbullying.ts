...
export const CYBERBULLYING_AUDIT_EVENTS = {
  ...
  // C12 — redaction / four-eyes approval / export authorization. Sanitized — IDs /
  // status / field path / action / reason code / classification only; NEVER source
  // values, replacement source, notes, recipient PII, or the snapshot payload.
  redactionDraftCreated: "cyberbullying.compliance_redaction.draft_created",
  redactionRuleAdded: "cyberbullying.compliance_redaction.rule_added",
  redactionRuleUpdated: "cyberbullying.compliance_redaction.rule_updated",
  redactionRuleRemoved: "cyberbullying.compliance_redaction.rule_removed",
  redactionSubmitted: "cyberbullying.compliance_redaction.submitted",
  redactionRejected: "cyberbullying.compliance_redaction.rejected",
  redactionApproved: "cyberbullying.compliance_redaction.approved",
  redactionSnapshotCreated: "cyberbullying.compliance_redaction.snapshot_created",
  redactionDraftCancelled: "cyberbullying.compliance_redaction.cancelled",
  exportAuthorizationRequested: "cyberbullying.compliance_export.authorization_requested",
  exportAuthorizationApproved: "cyberbullying.compliance_export.authorization_approved",
  exportAuthorizationRejected: "cyberbullying.compliance_export.authorization_rejected",
  exportAuthorizationCancelled: "cyberbullying.compliance_export.authorization_cancelled",
  exportPackageManifestPrepared: "cyberbullying.compliance_export.package_manifest_prepared",
  complianceIdempotentReplay: "cyberbullying.compliance_workflow.idempotent_replay",
