...
/** Policy console error boundary — safe generic message + retry; NEVER surfaces the raw error. */
  ...
  return (
    <div className="mx-auto max-w-lg px-6 py-16 text-center" role="alert">
      <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-8">
        ...
        <p className="mt-2 text-sm text-[var(--color-muted)]">The policy console couldn't load. Please try again.</p>
