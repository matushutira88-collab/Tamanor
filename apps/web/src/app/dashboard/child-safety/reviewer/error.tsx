...
/**
 * Reviewer Console — error boundary. Renders a safe, generic message + a retry; it NEVER surfaces the raw
 * error (no message, stack, id, or query) to the reviewer.
 */
  ...
  return (
    <div className="mx-auto max-w-lg px-6 py-16 text-center" role="alert">
      <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-8">
        ...
        <p className="mt-2 text-sm text-[var(--color-muted)]">The reviewer console couldn't load. Please try again.</p>
