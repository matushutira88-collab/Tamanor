...
const EN: Copy = {
  ...
  orbEyebrow: "One shield, everyone under it", orbA: "Protection that reaches", orbB: "every person", orbBody: "From the brand manager watching a comment storm to the parent worried about a child online — the same engine has their back.", roles: ["Marketing", "Support", "Brand owner", "Parent", "Guardian", "Caregiver"], engineLbl: "Tamanor engine",
...
const SK: Copy = {
  ...
  orbEyebrow: "Jeden štít, všetci pod ním", orbA: "Ochrana, ktorá dosiahne", orbB: "každého človeka", orbBody: "Od brand manažéra, čo sleduje búrku komentárov, po rodiča, čo sa bojí o dieťa online — rovnaký engine kryje chrbát všetkým.", roles: ["Marketing", "Podpora", "Majiteľ značky", "Rodič", "Opatrovník", "Blízky"], engineLbl: "Tamanor engine",
...
const DE: Copy = {
  ...
  orbEyebrow: "Ein Schild, alle darunter", orbA: "Schutz, der", orbB: "jeden Menschen", orbBody: "Vom Brand-Manager, der einen Kommentarsturm beobachtet, bis zum Elternteil, das sich um ein Kind sorgt — dieselbe Engine schützt sie alle.", roles: ["Marketing", "Support", "Markeninhaber", "Elternteil", "Erziehungsberechtigte", "Angehörige"], engineLbl: "Tamanor Engine",
  ...
  famPlans: [{ name: "Family", tagline: "Ruhiger Schutz für ein Kind.", cta: "Kostenlos starten", features: ["Bis zu 3 Profile", "Erziehungsberechtigte & Einwilligung", "Sicherheitssignale"] }, { name: "Family Plus", tagline: "Für die ganze Familie, zusammen.", cta: "Kostenlos starten", features: ["Bis zu 5 Profile", "Erweiterte Kontrollen", "Prioritäts-Signale"] }, { name: "Family Pro", tagline: "Für große oder Patchwork-Haushalte.", cta: "Kostenlos starten", features: ["Unbegrenzte Profile", "Alle Kontrollen", "Rollen für Erziehungsberechtigte"] }, { name: "Custom", tagline: "Schulen, Vereine und größere Setups.", cta: "Kontaktiere uns", features: ["Individuelles Setup", "DSGVO-Hilfe", "Prioritäts-Support"] }],
      ...
      <section style={{ position: "relative", padding: "100px 0", textAlign: "center", overflow: "hidden", background: "radial-gradient(50rem 26rem at 50% 120%, rgba(37,99,235,.08), transparent 65%)" }}>
        <div style={{ position: "relative", zIndex: 1, maxWidth: 1240, margin: "0 auto", padding: "0 26px" }}>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 24 }}>
            {[IMG.teen, IMG.parent, IMG.support, IMG.marketing, IMG.grand, IMG.adam].map((src, i) => (
          ...
          <div style={{ marginTop: 12, background: "#fff", border: `1px solid ${C.line}`, borderRadius: 11, padding: 13 }}>
            ...
            {mode === "business" ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
                {[{ n: "Sofia", s: "14 · Instagram" }, { n: "Jakub", s: "11 · YouTube" }].map((p) => (
                  <div key={p.n} style={{ display: "flex", alignItems: "center", gap: 10, border: `1px solid ${C.line}`, borderRadius: 10, padding: "9px 11px" }}>
                    <span style={{ height: 34, width: 34, borderRadius: "50%", flexShrink: 0, display: "grid", placeItems: "center", fontWeight: 700, fontSize: 13, color: acc.deep, background: `color-mix(in srgb, ${acc.a} 16%, transparent)` }}>{p.n[0]}</span>
