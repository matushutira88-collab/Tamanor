...
export const en = {
  ...
  landingV2: {
    ...
    heroA: "The wall between your brand", heroB: "& the internet.",
    ...
    protocolEyebrow: "The Tamanor protocol", phasesA: "Six phases.", phasesB: "You stay in control.", phaseWord: "Phase",
    ...
    actorEyebrow: "Tamanor risk engine", radarA: "Risk builds over time —", radarB: "not one comment at a time.",
    ...
    commandEyebrow: "Tamanor Control Center", cmdA: "AI proposes.", cmdB: "You decide.",
    ...
    diagnosticsEyebrow: "Tamanor diagnostics", diagA: "Safe", diagB: "by design.",
    ...
    pass: "PASS",
    pricingEyebrow: "Pricing", priceA: "Arm your accounts.", priceB: "Start free.",
    ...
    faqEyebrow: "Query the system", faqTitle: "Straight answers.",
    faqs: [
    ...
    ctaA: "Raise the wall", ctaB: "tonight.",
