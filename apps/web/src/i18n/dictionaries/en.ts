...
export const en = {
  ...
  landingV2: {
    ...
    online: "Online",
    heroEyebrow: "Live defense system · EU",
    heroA: "The wall between your brand", heroB: "& the internet.",
    heroBody: "Every comment, review and message on your connected accounts passes through Tamanor. Spam, scams and threats are stopped at the wall — held for human approval. Real feedback flies straight through.",
    ...
    protocolEyebrow: "The protocol", phasesA: "Six phases.", phasesB: "Zero autonomy.", phaseWord: "Phase",
    phasesSub: "Everything below ships today. The AI proposes — a human disposes. Always.",
    steps: [
    ...
    actorEyebrow: "Actor risk", radarA: "Repeat offenders don’t get a", radarB: "second first impression.",
    radarBody: "Tamanor tracks risky behavior per actor across time. Four risky comments in 24 hours? The actor crosses the risk threshold and every future message gets flagged before your audience ever sees it.",
    actors: [
      { a: "actor · fb:8842", s: "RISK 0.91 ▲ watchlist" },
      { a: "actor · ig:2214", s: "RISK 0.44 · elevated" },
      { a: "actor · fb:1093", s: "RISK 0.06 · clear" },
    ],
    commandEyebrow: "Command authority", cmdA: "AI proposes.", cmdB: "You dispose.",
    cmdBody: "Nothing is hidden, deleted or answered without a human pressing the button. Normal criticism is never touched — the firewall separates feedback from attacks, and you set where the line sits.",
    cmdCursor: "It’s not censorship. It’s a firewall",
    ...
    diagnosticsEyebrow: "Diagnostics", diagA: "Safe", diagB: "by design.",
    ...
    tags: { threat: ["SCAM", "SPAM", "THREAT", "PHISH", "ABUSE"], clean: ["OK", "FEEDBACK", "QUESTION", "REVIEW"] },
  },
};
