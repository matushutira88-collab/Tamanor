...
export const en = {
  ...
  onboarding: {
    ...
    subtitle: "Each step is confirmed automatically from your workspace — nothing to tick off by hand.",
    progress: "{done} of {total} steps done",
    next: "Next",
    doneLabel: "Done",
    recommended: "Recommended",
    recommendedNote: "Not required to finish setup — it completes once you review your first flagged item.",
    collapse: "Collapse",
    expand: "Expand",
